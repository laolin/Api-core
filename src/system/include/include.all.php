...
require_once api_g('path-sys').'/include/class.laolindb.php';
...
require_once api_g('path-sys').'/include/class.FEED.php';
require_once api_g('path-sys').'/include/class.COMMENT.php';
